...
Build Docker image cho Spring Boot, chạy container trên EC2 và kết nối RDS/Resend bằng cấu hình runtime an toàn.
...
Trên EC2, tạo `/home/ec2-user/ewallet-backend.env` với giá trị production. Không chụp nội dung file. File gồm cấu hình profile, RDS, JWT, frontend/CORS và Resend SMTP.
...
## Bước 5: Cấu hình Resend

Production dùng SMTP `587`, authentication và STARTTLS. Cloudflare giữ record xác minh sender domain. Không dùng Amazon SES và không mở inbound SMTP port trên EC2.

> **Hình cần bổ sung:** Resend domain Verified và email verification/reset đã nhận.
